...
var possibleValues = require('./testData').possibleValues
...
describe('Soldier generator', function() {
  ...
  it('should contain the expected amount of values', function() {
    expect(Object.keys(properties)).to.have.lengthOf(48)
  })

  it('each categories should contain the expected number of values', function() {
    for (var i of Object.keys(properties)) {
      expect(properties[i].length).to.equal(possibleValues[i])
    }
  })
})